...
/*   Updated: 2022/08/24 15:08:41 by yolee            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philosophers.h"

static void	thread_join_all(t_simul_data *simul_data, t_table_data *table_data)
{
	int	loop;
...
static void	check_philo(t_simul_data *simul_data, t_table_data *table_data)
{
	...
	while (loop < simul_data->num_philo)
	{
		time_now = conv_timeval_to_ms(calc_curr_time(
